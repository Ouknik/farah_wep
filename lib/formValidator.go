...
func (f *FormHandler) ValidateMobileNumberMoroccanFormat(mobileNumber string) (string, string, bool) {
	if len(mobileNumber) <= 9 {
		return "", "", false
	}

	var moroccanCountryCode = "+212"

	return moroccanCountryCode, mobileNumber, true
