...
func (d *DbAdapter) getMysqlConfig() *Credentials {
	...
	dbCredentials.host = "localhost" //"b31p1qobtenpsqlurvhq-mysql.services.clever-cloud.com" //d.getEnvConf("MP_API_DATABASE_HOST")
	dbCredentials.port = "3306"
	dbCredentials.database = "farah" // d.getEnvConf("MP_API_DATABASE_DB")
	dbCredentials.user = "root"      // d.getEnvConf("MP_API_DATABASE_USERNAME")
